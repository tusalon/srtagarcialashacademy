...
Si no puedes asistir, contactanos por WhatsApp al +53 ${telefonoDuenno}`;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-100 to-purple-200 pb-20">
            {/* Header */}
            <div className="bg-white/90 backdrop-blur-sm shadow-sm sticky top-0 z-10 border-b border-purple-300">
            ...
            <div className="max-w-3xl mx-auto px-4 py-6">
                ...
                {/* Info del cliente */}
                <div className="bg-white/80 backdrop-blur-sm border border-purple-300 rounded-lg p-4 mb-6">
                ...
                {mensajeError && (
                    <div className="bg-purple-200 border border-purple-400 text-pink-700 p-3 rounded-lg mb-4 text-sm">
                        {mensajeError}
                    </div>
                )}
                    ...
                    <button
                        ...
                        className={`
                            ...
                            ${filtro === 'activas' 
                                ...
                                : 'bg-purple-200 text-pink-700 hover:bg-purple-300'}
                        `}
                    >
                ...
                {loading ? (
                    ...
                    <div className="text-center py-12 bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-purple-300">
                        ...
                        {reservasFiltradas.map(booking => {
                            ...
                            return (
                                <div
                                    key={booking.id}
                                    className={`
                                        bg-white/90 backdrop-blur-sm rounded-xl shadow-sm border-l-4 overflow-hidden border border-purple-300
                                        ${booking.estado === 'Cancelado' 
                                            ? 'border-l-purple-500 opacity-70' 
                                            : 'border-l-purple-600'}
                                    `}
                                >
                                    <div className="p-4">
                                        <div className="flex justify-between items-start mb-3">
                                            ...
                                            <span className={`
                                                ...
                                                ${booking.estado === 'Reservado' ? 'bg-purple-200 text-pink-700' :
                                                  booking.estado === 'Confirmado' ? 'bg-purple-300 text-pink-800' :
                                        ...
                                        {booking.estado !== 'Cancelado' && (
                                            <div className={`
                                                ...
                                                ${puedeCancelarBooking 
                                                    ...
                                                    : 'bg-purple-200 text-pink-700 border border-purple-400'}
                                            `}>
                                        ...
                                        {booking.estado !== 'Cancelado' && (
                                            <button
                                                ...
                                                className={`
                                                    ...
                                                    ${puedeCancelarBooking
                                                        ? 'bg-purple-200 hover:bg-purple-300 text-pink-700'
