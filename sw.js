...
const CACHE_NAME = 'srtagarcialashacademy-v49';
const urlsToCache = [
  ...
  '/srtagarcialashacademy/calendar.html',
  ...
  '/srtagarcialashacademy/utils/push-config.js',
  '/srtagarcialashacademy/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/srtagarcialashacademy/icons/icon-192x192.png',
    badge: '/srtagarcialashacademy/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/srtagarcialashacademy/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/srtagarcialashacademy/admin.html';
  event.waitUntil(
